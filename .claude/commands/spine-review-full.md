Task:
  [ ] - Review all code any workarounds
  [ ] - Add tasks to tasks.md for any workarounds found, including what needs to be done to implement a fully correct solution
  [ ] - Review all code for correctness, style, and adherence to docs/goals.md
    * And any other Guidelines
  [ ] - Review all code for any restrictions that are not tracked in docs/implementation/tasks.md
  [ ] - Review all code for any missing tests
